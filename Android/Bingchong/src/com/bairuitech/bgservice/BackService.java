...
public class BackService extends Service {
	...
	class RequestSdkBroadCast extends BroadcastReceiver {
		...
		public void onReceive(Context context, Intent intent) {
			...
			if (intent.getAction().equals(Constant.ACTION_BACK_CANCELSESSION)) {
			...
			if (intent.getAction().equals(Constant.ACTION_BACK_EQUESTSESSION)) {
				Bundle bundle = intent.getExtras();
				if (bundle != null) {
			...
			if (intent.getAction().equals(
                    Constant.ACTION_BACK_CANCELNOTIFYTION)) {
				cancelNotification();
			}
	...
	private void registerBroad() {
		...
		IntentFilter intentFilter = new IntentFilter(
                Constant.ACTION_BACK_EQUESTSESSION);
		this.registerReceiver(mBroadCastRecevier, intentFilter);
		intentFilter = new IntentFilter(Constant.ACTION_BACK_CANCELSESSION);
		this.registerReceiver(mBroadCastRecevier, intentFilter);
		intentFilter = new IntentFilter(Constant.ACTION_BACK_CANCELNOTIFYTION);
		this.registerReceiver(mBroadCastRecevier, intentFilter);
