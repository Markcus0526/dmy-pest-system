...
public class ConfigEntity {
	...
	public String ip = "120.193.233.26";
	//public String ip = "221.199.187.36";
	public int port = 8906;
	
	public int configMode = VIDEO_MODE_SERVERCONFIG;
	public int resolution_width = 1280;
	public int resolution_height = 760;
	
	public int videoBitrate = 500*1000;						// 本地视频码率
	public int videoFps = 25;								// 本地视频帧率
	public int videoQuality = VIDEO_QUALITY_BEST;
