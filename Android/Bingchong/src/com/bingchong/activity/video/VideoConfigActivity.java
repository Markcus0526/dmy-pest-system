...
import com.bingchong.ConfigEntity;
import com.bingchong.ConfigService;
import com.bingchong.R;
import com.bingchong.ScreenInfo;

/**
 * @class：VideoConfigActivity.java 
 * @description: 视频设置页
 * @author: 金铁钢
 * 
 * @history:
...
public class VideoConfigActivity extends Activity{
	...
	private final String[] videoSizeString={"176 x 144", "320 x 240（默认）", "352 x 288", "640 x 480", "720 x 480", "1280 x 720" , "1920 x 1080"};
	private final int[] videoWidthValue={176,320,352,640,720,1280,1920};
	private final int[] videoHeightValue={144,240,288,480,480,720,1080};
    ...
    {   
    	...
    	fullLayout =  (LinearLayout) findViewById(R.id.config_ll);
    	...
    	fullLayout.addView(sv,new LayoutParams(ScreenInfo.WIDTH,LayoutParams.FILL_PARENT));
