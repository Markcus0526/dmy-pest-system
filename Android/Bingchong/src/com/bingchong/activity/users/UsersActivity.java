...
public class UsersActivity extends SuperActivity implements OnClickListener, OnClickItemAdapterListener, OnItemSelectedListener {
	...
	private ArrayList<XianBean> arrPos = new ArrayList<XianBean>();
	ArrayAdapter<XianBean> 		AXian = null;
	...
	protected void onCreate(Bundle savedInstanceState) {
		super.onCreate(savedInstanceState, R.layout.users);
	}
    ...
    private void refreshList(){
        startProgress();
        CommManager.getUsers(0, mNowLevel, mNowShengId, mNowShiId, mNowXianId, "", get_users_handler);
    }
	...
	public void onItemSelected(AdapterView<?> parent, View view, int position, long id) {
        ...
        if(spinner.getId() == R.id.spinner_level){
            mNowLevel = Global.getUserLevelIndex(arrLevel.get(position));
            refreshList();
        }
    ...
    private void clearShengSpinner()
    {
        arrSheng.clear();
        ArrayAdapter<XianBean> adapterSheng = new ArrayAdapter<XianBean>(this, R.layout.item_spinner_white, arrSheng);
        adapterSheng.setDropDownViewResource(android.R.layout.simple_spinner_dropdown_item);
    ...
    private AsyncHttpResponseHandler get_shengs_handler = new AsyncHttpResponseHandler() {
        ...
        public void onSuccess(String content) {
            ...
            try {
                ...
                if (nRetCode == ConstMgr.SVC_ERR_NONE) {
                    ...
                    AppCommon.showToast(UsersActivity.this, stRetMsg);
                }
            } catch (Exception ex) {
                ex.printStackTrace();
                AppCommon.showDebugToast(UsersActivity.this, ex.getMessage());
            }
        }
        ...
        public void onFailure(Throwable error, String content) {
            ...
            AppCommon.showToast(UsersActivity.this, R.string.STR_CONN_ERROR);
        }
    };
