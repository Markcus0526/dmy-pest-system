...
public class HistoryActivity extends SuperActivity implements OnClickListener, OnClickItemAdapterListener, OnItemSelectedListener {
	...
	private int xian_pos = 0;
	
	private boolean isInited = false;

    private int mNowLevel = -1;  // -1:all, 0:guojia, 1:sheng, 2:shi, 3:xian
    private int mNowType = -1;   // -1:all, 0:guding, 1:feiguding
    private int mNowShengId = 0;
    private int mNowShiId = 0;
    private int mNowXianId = 0;

	protected void onCreate(Bundle savedInstanceState) {
		super.onCreate(savedInstanceState, R.layout.history);
	}
    ...
    private void refreshList(){
        startProgress();
        CommManager.getPoints(AppCommon.loadUserID(), mNowShengId, mNowShiId, mNowXianId, "", mNowType, mNowLevel, "", get_points_handler);
    }
	...
	public Object onTaskRunning(int taskId, Object data) {
		try{
			arrXians = DataMgr.getXians();
			mAllList = DataMgr.getPoints("", 0);
		} catch (Exception e){}
	...
	*/
	...
	public void OnClickListener(int index)
	{
        ...
        bundle.putString(Constant.EXTRA_PARAM_INDEX, String.valueOf(m_curPlace.id));
        pushNewActivityAnimated(HistoryListActivity.class, bundle);
	}
    ...
    private AsyncHttpResponseHandler get_shengs_handler = new AsyncHttpResponseHandler() {
        ...
        public void onSuccess(String content) {
            ...
            try {
                ...
                if (nRetCode == ConstMgr.SVC_ERR_NONE) {
                    ...
                    AppCommon.showToast(HistoryActivity.this, stRetMsg);
                }
            } catch (Exception ex) {
                ex.printStackTrace();
                AppCommon.showDebugToast(HistoryActivity.this, ex.getMessage());
            }
        }
        ...
        public void onFailure(Throwable error, String content) {
            ...
            AppCommon.showToast(HistoryActivity.this, R.string.STR_CONN_ERROR);
        }
    };
