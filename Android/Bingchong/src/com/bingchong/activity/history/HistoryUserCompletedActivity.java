 ...
 */
public class HistoryUserCompletedActivity extends SuperActivity  implements View.OnClickListener, OnClickItemAdapterListener {
    // for list view
    ...
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState, R.layout.history_user_completedd);
    }
    ...
    public void OnClickListener(int index)
    {
        ...
        bundle.putString(Constant.EXTRA_PARAM_TYPE, getString(R.string.history_user_type_completed));
    ...
    private AsyncHttpResponseHandler get_tasklist_handler = new AsyncHttpResponseHandler() {
            ...
            try {
                ...
                if (nRetCode == ConstMgr.SVC_ERR_NONE) {
                    ...
                    for (int i = 0; i < array.length(); i++) {
                        ...
                        if(obj != null) {
                            obj.setDisplayType(TaskBean.DISP_TYPE_HISTORY_COMPLETED);
                            mList.add(obj);
                        }
                    }
                    initUI();
                    ...
                    AppCommon.showToast(HistoryUserCompletedActivity.this, stRetMsg);
                }
            } catch (Exception ex) {
                ex.printStackTrace();
                AppCommon.showDebugToast(HistoryUserCompletedActivity.this, ex.getMessage());
            }
        }
        ...
        public void onFailure(Throwable error, String content) {
            ...
            AppCommon.showToast(HistoryUserCompletedActivity.this, R.string.STR_CONN_ERROR);
        }
    };
}