...
function initControlSelected() {
	...
	GetIndex("quality", quality_combo_value,BRAC_GetSDKOptionInt(BRAC_SO_LOCALVIDEO_QUALITYCTRL),"combobox"); // 当前使用的质量参数
	GetIndex("code_rate", bitrate_combo_value,BRAC_GetSDKOptionInt(BRAC_SO_LOCALVIDEO_BITRATECTRL),"combobox"); // 当前使用的码率参数
    GetIndex("distinguishability",resolution_txt, BRAC_GetSDKOptionInt(BRAC_SO_LOCALVIDEO_WIDTHCTRL) + "x" + 	BRAC_GetSDKOptionInt(BRAC_SO_LOCALVIDEO_HEIGHTCTRL), "combobox"); // 当前使用的的分辨率
...
$(function () {
    $("#advanceset_div_close").click(function () {
