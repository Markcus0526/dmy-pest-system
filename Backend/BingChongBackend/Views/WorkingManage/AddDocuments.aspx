    ...
    <div class="col-xs-12" style="margin-top:30px">
        <form class="form-horizontal" role="form" id="validation-form">
            ...
            <div class="form-group profile" style="margin-bottom:0px">
				...
				<div class="col-md-10">
                        <textarea cols="50" name="contents" id="contents" style="height:460px;width:100%" ></textarea>
...
<asp:Content ID="Content2" ContentPlaceHolderID="PageStyle" runat="server">
    ...
    <link href="<%= ViewData["rootUri"] %>Content/kindeditor/themes/default/default.min.css" rel="stylesheet" />
</asp:Content>
    ...
    <script type="text/javascript">
      ...
      function redirectToListPage(status) {
            if (status.indexOf("error") != -1) {
                ...
                window.location = '<%=ViewData["rootUri"]%>' + "WorkingManage/ManagingDocuments";
            }
        }
        var editor;
        KindEditor.ready(function (K) {
            $("#contents").text(unescape("<%=ViewData["contents"] %>"));
            editor = K.create('#contents', {
                cssPath: '<%= ViewData["rootUri"] %>Content/kindeditor/plugins/code/prettify.css',
                uploadJson: '<%= ViewData["rootUri"] %>WorkingManage/UploadKindEditorImageT',
                fileManagerJson: '<%= ViewData["rootUri"] %>WorkingManage/ProcessKindEditorRequestT',
        ...
        function submitform() {
         //   alert($('#validation-form').serialize());
           ...
           $.ajax({
	            type: "POST",
	            url: '<%= ViewData["rootUri"] %>' + 'WorkingManage/SubmitDocument',
	            dataType: "json",
	            data: {
                        uid: $("#uid").val(),
                        name: $("#name").val(),
                        contents: escape($("#contents").val())
                },
