	...
	<div class="col-xs-12">
		<form class="form-horizontal" id="validation-form">
			<div class="form-group">
				...
				<div class="col-sm-9">
                    <div class="clearfix">
					<input type="text" id="rolename" readonly name="rolename" placeholder="请输入角色名称" class="input-large form-control"  <% if (ViewData["rolename"] != null) { %>value="<%= ViewData["rolename"] %>"<% } %> />
                    </div>
				</div>
			</div>
			<div class="form-group">
				...
				<div class="col-sm-8">
                    ...
                    <table id="listTable" class="table table-bordered table-hover dataTable " style="clear:right; width:100%; margin:0px; padding:0px;">
                        <tbody>
							...
							<tr>
							    <td>
									<label class="" style="float:left;">测报点：</label>
							...
							<tr>
							    <td>
                                    <label style="float:left">汇总统计：</label>
							...
							<tr>
							    <td>
									...
									<label class="lbl" for="meta5-1"> 查寻</label>
                            ...
                            <tr>
							    <td>
									<label class="" style="float:left">通知：</label>
                                    <div class="" style="float:left;margin-left:35px">
                            ...
                            <tr>
							    <td>
									<label class="" style="float:left">用户管理：</label>
                                    <div class="" style="float:left;margin-left:34px;">
